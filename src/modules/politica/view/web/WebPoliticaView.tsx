        ...
        <div className="min-h-screen bg-white text-slate-900">
            ...
            <section className="relative bg-gradient-to-br from-slate-50 via-white to-amber-50 py-24 md:py-32 text-slate-900 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        Marco legal para brindar información clara y completa a nuestros clientes
                    </motion.p>
                    <motion.div
                    ...
                    >
                        ...
                        Confiabilidad y Respaldo Garantizado
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-16 bg-gradient-to-br from-slate-50 via-white to-amber-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <motion.div
                            className="w-24 h-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full mx-auto"
                            initial={{ width: 0 }}
                            ...
                            >
                                <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200 hover:shadow-2xl transition-all duration-300 h-full">
                                    ...
                                    <div className="text-center mb-8">
                                        <motion.div
                                            className={`w-16 h-16 bg-gradient-to-r ${policy.color} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg`}
                                    ...
                                    {policy.id === 1 && policy.phases && (
                                        <div className="space-y-4">
                                            <h4 className="font-semibold text-slate-900 mb-4">Fases del Proceso:</h4>
                                    ...
                                    {policy.id === 2 && policy.compliance && (
                                        <div className="space-y-4">
                                            <h4 className="font-semibold text-slate-900 mb-4">Cumplimiento Legal:</h4>
                                    ...
                                    {policy.id === 3 && policy.measures && (
                                        <div className="space-y-4">
                                            <h4 className="font-semibold text-slate-900 mb-4">Medidas de Control:</h4>
                                            {policy.measures.map((measure, measureIndex) => (
                                                <motion.div
                                                    ...
                                                    whileInView={{ opacity: 1, x: 0 }}
                                                    viewport={{ once: true }}
                                                    transition={{ delay: 0.5 + measureIndex * 0.1 }}
                                                >
                        ...
                        {[
                            ...
                            >
                                <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-200 group-hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                                    <motion.div
                                        className="w-12 h-12 bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg"
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center gap-8 text-sm">
                            <a href="#" className="text-amber-400 hover:text-amber-300 transition-colors duration-300">Política de privacidad</a>
                            <a href="#" className="text-amber-400 hover:text-amber-300 transition-colors duration-300">Política de Cookies</a>
                            <a href="#" className="text-amber-400 hover:text-amber-300 transition-colors duration-300">Aviso Legal</a>
                        </div>
...
export default WebPoliticaView;
